...
export const useScroll = async (socket) => {
    ...
    socket.on('scroll.signTransaction', signTransactionHandler(accountsStorage, socket))
    socket.on('scroll_signTransaction', signTransactionHandler_v2(accountsStorage))
